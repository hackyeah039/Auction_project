...
public class AuctionVo {
	...
	public AuctionVo() {};
	public AuctionVo(int a_num, String a_title, String a_content, int a_condition, Date a_regdate,Date a_startdate, Date a_enddate, int a_check, int c_num, int a_jjim, int s_num, int sel_number, int bidstatus, int a_startbid, int a_bidunit) {
		this.a_num =a_num;
