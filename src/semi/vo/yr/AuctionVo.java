...
public class AuctionVo {
	...
	private int c_num; //카테고리 숫자
	private int a_jjim; //관심물품 등록한 수
	private int sel_number;
	private int bidstatus;
	private int startbid;
	private int a_bidunit;//입찰 단위
	
	public AuctionVo(){};
	
	public AuctionVo(int a_num, String a_title, String a_content, int a_condition, Date a_regdate, Date a_startdate,
			Date a_enddate, int a_check, int c_num, int a_jjim, int sel_number, int bidstatus, int startbid,
			int a_bidunit) {
		super();
		this.a_num = a_num;
