...
CREATE TABLE SELLER
(
	-- ACCOUNT : java에서는 long타입으로 받아야 가능 
...
COMMENT ON COLUMN AUCTION.A_CONTENT IS '경매내용';
...
COMMENT ON COLUMN PAYMENT.PAY_DEADLINE IS 'PAY_DEADLINE';
...
COMMENT ON COLUMN SELLER.ACCOUNT IS 'ACCOUNT : java에서는 long타입으로 받아야 가능 ';
...
COMMENT ON COLUMN SHIP.A_NUM IS '경매번호';
