...
(
	...
	M_NUM number(5,0) NOT NULL,
	-- 신고번호
	PENALTY_NUM number(5) NOT NULL,
	-- 신고내용
	PENALTY_CONTENT varchar2(500) NOT NULL,
	PRIMARY KEY (PENALTY_NUM)
);
...
COMMENT ON COLUMN SINGO.PENALTY_NUM IS '신고번호';
COMMENT ON COLUMN SINGO.PENALTY_CONTENT IS '신고내용';
